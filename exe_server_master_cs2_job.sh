#!/bin/bash
# Script Name: exe_server_master_cs2_job.sh
# Author: Demirel
...
#SBATCH --output=output/jobs/slurm-exe_server_master_cs2_job-%j.out
#SBATCH --error=output/jobs/slurm-exe_server_master_cs2_job-%j.err
#SBATCH --job-name=PIDE-cs2-job
# -----------------------------------------
# Usage Comments
...
# Logging setup
LOG_FILE="/hkfs/home/haicore/iai/ii6824/Documents/PIDE/output/mcs_folder/exe_server_master_cs2_job.log"
echo "Log File for PIDE Case Study 2 Script" > "$LOG_FILE"  # Reset log file at start
...
log_message "Starting PIDE Case Study 2 Script"

# Default configurations
PYTHON_ENV="/hkfs/home/haicore/iai/ii6824/env/39_my_grid_env"
OUTPUT_NB_DIR="/hkfs/home/haicore/iai/ii6824/Documents/PIDE/output/mcs_folder"
DRY_RUN=false
...
#-------------------------------------------------------------------------
# Part 2:
pv_ctrl_list=("datasource" "voltage_reactive_power_ctrl" "power_factor_active_power_ctrl" "constant_power_factor_active_power_ctrl")
    ...
    # *(4): `constant_power_factor_active_power_ctrl` Constant Power Factor (cos phi_target,const) 
storage_p_ctrl_list=("rbc_pvbes_distributed_sc_ctrl" )
...
#-----------------------------------------------------------------------------------------------------------------
log_message "All simulations for Case Study 2 have been successfully completed."
