...
class PVControllerTest(PVController):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dpi = 350
        self.plot_test_names = [
            "_00_pVoltWattVAr_Diagram_",
    ...
    def run_rule_based_pv_control_vde_tests(self, net):
        ...
        active_power_range = np.linspace(
            self.min_p_mw, self.sn_mva + 2 * step_size, num_steps
        )
        ...
        for pv_control_mode, data in control_modes.items():
            ...
            for name, min_cos_phi_value, test_mode in zip(
                ...
                if test_mode:
                    ...
                    self.load_control_rule_settings(
                        net=net, element_type=self.der_element_type
                    )
